...
| **FlowAgent** | AI agent orchestration framework — multi-agent pipelines with task routing and memory | Python · TypeScript · Go | [Code](https://github.com/kahlelhawary-art/FlowAgent) |
